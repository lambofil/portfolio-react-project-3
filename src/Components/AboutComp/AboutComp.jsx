        ...
        <div className="roww">
          ...
          <div className="col__2">
            ...
            <div className='personal-info'>
              <h1><a href="/about" className='animate__animated animate__bounceInLeft'>Ayinde Akintayo O</a></h1>
